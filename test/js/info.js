...
$(function() {
	...
	for (var i = 0; i < data[0].length; i++) {
		...
		str8 += '<td>'+data[8][i]+'</td>';
		str9 += '<td>'+data[9][i]+'</td>';
		str10 += '<td>'+data[10][i]+'</td>';
		str11 += '<td>'+data[11][i]+'</td>';
		str12 += '<td>'+data[12][i]+'</td>';

	};
	console.log(str1);
	$('.table thead tr').append(name);
	/*for (var i = 0; i < data.length; i++) {
		$('.table tbody tr:eq('+i+')').html('str'+i);
	};
*/	
    $('.table tbody tr:eq(0)').append(str1);
    $('.table tbody tr:eq(1)').append(str2);
    $('.table tbody tr:eq(2)').append(str3);
    $('.table tbody tr:eq(3)').append(str4);
    $('.table tbody tr:eq(4)').append(str5);
    $('.table tbody tr:eq(5)').append(str6);
    $('.table tbody tr:eq(6)').append(str7);
    $('.table tbody tr:eq(7)').append(str8);
    $('.table tbody tr:eq(8)').append(str9);
    pageCon = 5;
	    liTab=3;    
